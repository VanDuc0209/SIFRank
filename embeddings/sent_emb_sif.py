...
class SentEmbeddings():
    ...
    def __init__(self,
                 word_embeddor,
                 weightfile_pretrain='/content/drive/My Drive/20192/SIFRank/auxiliary_data/enwiki_vocab_min200.txt',
                 weightfile_finetune='/content/drive/My Drive/20192/SIFRank/auxiliary_data/inspec_vocab.txt',
        ...
        if(database=="Inspec"):
            ...
            weightfile_finetune = '/content/drive/My Drive/20192/SIFRank/auxiliary_data/duc2001_vocab.txt'
        elif(database=="SemEval2017"):
            weightfile_finetune = '/content/drive/My Drive/20192/SIFRank/auxiliary_data/semeval_vocab.txt'
        else:
            weightfile_finetune = '/content/drive/My Drive/20192/SIFRank/auxiliary_data/enwiki_vocab_min200.txt'
